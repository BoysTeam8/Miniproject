	...
	Show.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                try {
                    ...
                    conn c = new conn();
                    String str = "select pnr_no,paid_amt,pay_date,cheque_no,ph_no from payment where pnr_no = '"+code+"'";
