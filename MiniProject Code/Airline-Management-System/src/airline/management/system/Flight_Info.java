...
public class Flight_Info extends JFrame{  //Second Frame
	...
	FlightDetails.setBounds(350, 20, 570, 35);
	add(FlightDetails);
	...
	btnShow.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select f_code,f_name,src,dst,capacity,class_code,class_name from flight ,sector where src = '"+code+"'and dst = '"+code1+"'";
	...
	textField = new JTextField("Source");
        textField.setBounds(220, 100, 200, 30);
        textField.addFocusListener(new FocusAdapter(){
            public void focusGained(FocusEvent evt)
            {
                if(textField.getText().equals("Source"))
                {
                    textField.setText("");
	...
	add(textField);
        ...
        textField1 = new JTextField("Destination");
        textField1.setBounds(520, 100, 200, 30);
        textField1.addFocusListener(new FocusAdapter(){
            public void focusGained(FocusEvent evt)
            {
                if(textField1.getText().equals("Destination"))
                {
                    textField1.setText("");
        ...
        textField1.addFocusListener(new FocusAdapter(){
            public void focusLost(FocusEvent evt)
            {
                ...
                {
                    textField1.setText("Destination");
