...
public class Cancel extends JFrame { //Sixth
	...
	CancellationDate.setBounds(60, 100, 180, 27);
	...
	textField_2.setBounds(250, 100, 150, 27);
	add(textField_2);
	...
	add(textField_4);
		...
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO cancellation values('"+ticket_id+"','"+cancellation_date+"','"+flight_code+"')";
