...
public class Journey_Details extends JFrame{  //Forth
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select ticket_id,f_code,jny_date,jny_time,src,dst from reservation where src = '"+src+"' and dst = '"+dst+"'";
